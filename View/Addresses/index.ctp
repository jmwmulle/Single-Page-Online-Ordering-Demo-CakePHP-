<div class="addresses index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('building_type'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($address['Address']['building_type']); ?>&nbsp;</td>
		<td><?php echo h($address['Address']['postal_code']); ?>&nbsp;</td>
		<td><?php echo h($address['Address']['city']); ?>&nbsp;</td>
		<td><?php echo h($address['Address']['province']); ?>&nbsp;</td>
		<td><?php echo h($address['Address']['note']); ?>&nbsp;</td>
		<td><?php echo h($address['Address']['delivery_time']); ?>&nbsp;</td>
		<td><?php echo h($address['Address']['confirmation']); ?>&nbsp;</td>
		<td class="actions">
