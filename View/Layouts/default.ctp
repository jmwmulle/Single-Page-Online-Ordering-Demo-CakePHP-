						...
						<div class="large-9 columns">
							<div>
								...
								<nav class="scroll-area up" <?php echo ___dA($scrollUpAttr);?>></nav>
									<div id="primary-content" class="large-12 columns content-area" data-scrolling-target data-initial-offset="0">
										<?php if (!$this->get('isSplash') ) echo $this->fetch('content');?>
									</div>
								<nav class="scroll-area down" <?php echo ___dA($scrollDownAttr);?>></nav>
							</div>
						</div>
						<nav id="subnav-toc" class="large-3 columns container" data-scrolling-target>
