...
<?php echo $this->Form->create('OrbsOrbcat'); ?>
	<fieldset>
		<legend><?php echo __('Edit Orbs Orbcat'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OrbsOrbcat.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('OrbsOrbcat.id'))); ?></li>
