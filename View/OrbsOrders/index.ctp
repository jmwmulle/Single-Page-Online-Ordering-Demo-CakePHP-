<div class="orbsOrders index">
	<h2><?php echo __('Orbs Orders'); ?></h2>
	...
	<tbody>
	<?php foreach ($orbsOrders as $orbsOrder): ?>
	<tr>
		<td><?php echo h($orbsOrder['OrbsOrder']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($orbsOrder['OrbsOrder']['config']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $orbsOrder['OrbsOrder']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $orbsOrder['OrbsOrder']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $orbsOrder['OrbsOrder']['id']), array(), __('Are you sure you want to delete # %s?', $orbsOrder['OrbsOrder']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
