...
var xbs_routing = {
	...
	routes: {},
	route_groups: null,
	import_route_groups: function () {
		// a small adapter allowing route-grouping for readability without changing original routing functions
		for (var route_group in XBS.routing.route_groups) {
			var route_group = XBS.routing.route_groups[route_group];
			for (var route in route_group) {
				XBS.routing.routes[route] = route_group[route];
			}
		}
	},
